...
impl EventKind {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::SceneRenamed => "scene.renamed",
            Self::SceneDeleted => "scene.deleted",
            Self::SceneReordered => "scene.reordered",
            ...
            Self::VolumeRenamed => "volume.renamed",
            Self::VolumeDeleted => "volume.deleted",
            Self::VolumeReordered => "volume.reordered",
